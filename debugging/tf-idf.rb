...
def idf(term, documents)
  ...
  # Must perform float division here for precision
  # This assumes that at least one document contains the given term -- otherwise,
  # the division will retun an error
